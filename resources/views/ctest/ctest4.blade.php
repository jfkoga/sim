...
@section('title', 'C-Test 4')

@section('content')
    <form action="{{ route('ctest.progress', [encrypt(4), encrypt($question->id)]) }}" method="POST">
        @csrf
        <div class="container">
            <h4 class="card-title">C-Test (Step 4)</h4>
                ...
                <div class="row g-0 exercici">
                    ...
                    <div class="col-md-3 breadcrumb">
                        ...
                        <div class="bready">
                            ...
                            <span class="badge bg-primary rounded-pill page active">4</span>
                        </div>
                        <div class="TimeCount">
        ...
        <div class="botons">
            ...
            <button type="submit" name="action" value="next" class="btn btn-primary rounded-pill"
                style="justify-self: right;">{{ __('Finish C-Test') }}</button>
        </div>
    </form>
