...
@section('title', 'C-Test 3')

@section('content')
    <form action="{{ route('ctest.progress', [encrypt(3), encrypt($question->id)]) }}" method="POST">
        @csrf
        <div class="container">
            <h4 class="card-title">C-Test (Step 3)</h4>
                ...
                <div class="row g-0 exercici">
                    ...
                    <div class="col-md-3 breadcrumb">
                        ...
                        <div class="bready">
                            ...
                            <span class="badge bg-primary rounded-pill page active">3</span>
