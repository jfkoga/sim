...
@section('title', 'C-Test 1')

@section('content')
    <form action="{{ route('ctest.progress', [encrypt(1), encrypt($question->id)]) }}" method="POST">
        @csrf
        <div class="container">
            <h4 class="card-title">C-Test (Step 1)</h4>
            ...
            <div class="card exer mb-3">
                <div class="row g-0 exercici">
                    ...
                    <div class="col-md-3 breadcrumb">
                        <h4>{{ __('Exercise') }} 1</h4>
                        <div class="bready">
                            <span class="badge bg-primary rounded-pill page active">1</span>
